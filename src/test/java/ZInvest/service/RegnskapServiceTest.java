...
class RegnskapServiceTest {
    ...
    void testHentInntektRegnskapForFlereAar() {
        ...
        assertThat(regnskap.get(4).getLabel()).isEqualTo("Mars");
        assertThat(regnskap.get(4).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(4).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(5).getLabel()).isEqualTo("April");
        assertThat(regnskap.get(5).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(5).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(6).getLabel()).isEqualTo("Mai");
        assertThat(regnskap.get(6).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(6).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(7).getLabel()).isEqualTo("Juni");
        assertThat(regnskap.get(7).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(7).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(8).getLabel()).isEqualTo("Juli");
        assertThat(regnskap.get(8).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(8).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(9).getLabel()).isEqualTo("August");
        assertThat(regnskap.get(9).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(9).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(10).getLabel()).isEqualTo("September");
        assertThat(regnskap.get(10).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(10).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(11).getLabel()).isEqualTo("Oktober");
        assertThat(regnskap.get(11).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(11).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(12).getLabel()).isEqualTo("November");
        assertThat(regnskap.get(12).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(12).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(13).getLabel()).isEqualTo("Desember");
        assertThat(regnskap.get(13).getBelopList().get(0)).isEqualTo(0L);
        assertThat(regnskap.get(13).getBelopList().get(1)).isEqualTo(0L);
        assertThat(regnskap.get(15).getLabel()).isEqualTo("Sum brutto inntekt (føres i skattemeldingen)");
        assertThat(regnskap.get(15).getBelopList().get(0)).isEqualTo(3000L);
        assertThat(regnskap.get(15).getBelopList().get(1)).isEqualTo(4000L);
        assertThat(regnskap.get(16).getLabel()).isEqualTo("Sum utgifter");
        assertThat(regnskap.get(16).getBelopList().get(0)).isEqualTo(500L);
        assertThat(regnskap.get(16).getBelopList().get(1)).isEqualTo(800L);
        assertThat(regnskap.get(16).getAarList().get(0)).isEqualTo("2021");
        assertThat(regnskap.get(16).getAarList().get(1)).isEqualTo("2022");
        assertThat(regnskap.get(17).getLabel()).isEqualTo("Sum brutto inntekt (etter trekk av alle utgifter)");
        assertThat(regnskap.get(17).getBelopList().get(0)).isEqualTo(2500L);
        assertThat(regnskap.get(17).getBelopList().get(1)).isEqualTo(3200L);
        assertThat(regnskap.get(19).getLabel()).isEqualTo("Estimert skatt");
        assertThat(regnskap.get(19).getBelopList().get(0)).isEqualTo(550L);
        assertThat(regnskap.get(19).getBelopList().get(1)).isEqualTo(704L);
        assertThat(regnskap.get(22).getLabel()).isEqualTo("Estimert netto inntekt (brutto inntekt trukket fra alle utgifter og estimert skatt)");
        assertThat(regnskap.get(22).getBelopList().get(0)).isEqualTo(1950L);
        assertThat(regnskap.get(22).getBelopList().get(1)).isEqualTo(2496L);
    }
